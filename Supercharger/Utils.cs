...
internal class Utils
{
    ...
    public static bool IsHangarShipSuperchargeStationBehaviour(SuperchargeStationBehaviour superchargeStationBehaviour)
    {
        if (!TryGetHangarShipSuperchargeStationBehaviour(out SuperchargeStationBehaviour hangarShipSuperchargeStationBehaviour))
        {
            return false;
        }
    ...
    public static bool TryGetHangarShipSuperchargeStationBehaviour(out SuperchargeStationBehaviour superchargeStationBehaviour)
    {
        GameObject chargeStationObject = GameObject.Find("/Environment/HangarShip/ShipModels2b/ChargeStation");
